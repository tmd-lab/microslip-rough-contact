function [Q,T] = ZTE_ND2QP(MESH,No)
...
%   			quadrature points to integrated nodal
    ...
    for e=1:MESH.Ne_Tri
        ...
        T(nds,(e-1)*Nq+(1:Nq)) = T(nds,(e-1)*Nq+(1:Nq))+Jd'.* ...
            (Q((e-1)*Nq+(1:Nq),nds))'.*Ws';
    end
    ...
    for e=1:MESH.Ne_Quad
        ...
        T(nds,(MESH.Ne_Tri+e-1)*Nq+(1:Nq)) = T(nds,(MESH.Ne_Tri+e- ...
                                                    1)*Nq+(1:Nq))+ ...
            Jd'.*(Q((MESH.Ne_Tri+e-1)*Nq+(1:Nq),nds))'.*Ws';
    end
end