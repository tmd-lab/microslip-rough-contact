function [txyn, dtxynduxyn, prev] = RC_TRACTION(pars, uxyn, prev, ASP_FUN, PZFUN, Nqp_heights, Nqp_radius, zmin, zmax, area_density)
...
%   ASP_FUN - Function of forces in all directions for an asperity
%   PZFUN - Probability Density function for asperity gaps. Minimimum gap
%           should be zero, maximum should be zmax 
